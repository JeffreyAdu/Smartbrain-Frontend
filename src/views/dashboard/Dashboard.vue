      ...
      <div class="grid gap-8">
        ...
        <div class="bg-white shadow-md rounded-lg hover:shadow-lg transition-shadow duration-300">
          ...
          <div class="border-t border-gray-200 px-6 py-5">
            <div v-if="faceDetectionStore.history.length === 0" class="text-center py-8">
              <p class="text-gray-500">No recent activity found</p>
              <router-link to="/face-detection" class="mt-4 inline-block text-primary hover:text-primary-dark">
              ...
              <li v-for="(item, index) in faceDetectionStore.history.slice(0, 5)" :key="index" class="py-4">
                <div class="flex items-center space-x-4">
                  <div class="flex-shrink-0">
                    <img class="h-14 w-14 rounded-md object-cover shadow-sm" :src="item.url" alt="Image thumbnail" />
                  </div>
          ...
          <div v-if="faceDetectionStore.history.length > 0" class="border-t border-gray-200 px-6 py-4">
            <router-link to="/face-detection" class="text-sm font-medium text-primary hover:text-primary-dark flex items-center">
              View all activity
        ...
        <div class="bg-white shadow-md rounded-lg hover:shadow-lg transition-shadow duration-300">
          <div class="px-6 py-5">
            ...
            <div class="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div class="bg-gray-50 overflow-hidden rounded-lg shadow-sm border border-gray-100">
                <div class="px-5 py-5">
                  ...
                  <div class="mt-4">
                    <router-link
                      to="/face-detection"
                      class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors duration-200"
                    >
